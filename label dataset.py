...
classes = ["bee","cat","chicken","chicken_seed","cow","cow_wheat","creeper","duck","ender","enderman","flower","fox","frog","ghast",
           "goat","horse","llama","people","person","pig","pig_carrot","polar","bear","rabbit","sheep","sheep_wheat","skeleton",
           "spider","turtle","villager","witch","wolf","wolf_bone","zombie"]
